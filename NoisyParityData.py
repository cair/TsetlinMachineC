...
for i in range(number_of_examples):
	...
	Y_train[i] = (X_train[i, 0] + X_train[i, 1] + X_train[i, number_of_variables - 2] + X_train[i, number_of_variables - 1]) % 2
...
for i in range(number_of_examples):
	...
	Y_test[i] = (X_test[i, 0] + X_test[i, 1] + X_test[i, number_of_variables - 2] + X_test[i, number_of_variables - 1]) % 2	
